...
/*******************FILTERING*************************************/
/*INTERNAL*/
Model.prototype.filterWarapper = function(/*req*/attribName, /*nullable*/property, /*nullable*/input, filterFunc, clearCachedResults, storeFilterResults, isInputFilter){
  ...
  */
  ...
  var Model = this;
  var results = [];
  var target = Map.getAttribute(Model.modelName, attribName);
...
Model.prototype.filter = function(attribName){
  var chain = {};
  var Model = this;
  var clearCachedResults = true;
  var storeFilterResults = void(0);
  var defaultFilter = function(input, item){
  ...
  chain.using = function(atrribNameOrFunction){
    ...
    chain.and = function(comparitorFunc){
      ...
      if(_.isFunc(comparitorFunc)){
        ...
        chain.liveAndFuncs.sort(function(a){
